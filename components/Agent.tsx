...
const Agent = ( { userName, userId, type }: AgentProps  ) => {
    ...
    useEffect(() => {
        // Fetch or initialize messages here
        ...
        const onSeechStart = () => setIsSpeaking(true);
        ...
        vapi.on('speech-start', onSeechStart);
        ...
        return () => {
            ...
            vapi.off('speech-start', onSeechStart);
    ...
    const messages = [
        'what is your name?',
        'I am your Ai interviewer, nice to meet you!',
    ];
